    ...
    public void a(Packet10Flying packet10flying) {
        ...
        if (!this.player.viewingCredits) {
            ...
            if (this.checkMovement && !this.player.dead) {
                ...
                if (d8 > 10000.0D && this.checkMovement) { // CraftBukkit - Added this.checkMovement condition to solve this check being triggered by teleports
                ...
                if (d8 > 2000.0625D && !this.player.isSleeping() && !this.player.itemInWorldManager.isCreative()) {
                    flag1 = true;
